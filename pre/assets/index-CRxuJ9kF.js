...
const def = (obj, key, value, writable2 = false) => {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const unmountComponent = (instance, parentSuspense, doRemove) => {
    const { bum, scope, update: update3, subTree, um, m, a } = instance;
    invalidateMount(m);
    invalidateMount(a);
    if (bum) {
      invokeArrayFns(bum);
...
var __publicField$p = (obj, key, value) => __defNormalProp$O(obj, key + "", value);
const eventBus = mitt();
const eventBus$1 = {
  fire(event) {
...
const _RenderUpdatedEvent = class _RenderUpdatedEvent2 {
  constructor() {
    __publicField$p(this, "kind", _RenderUpdatedEvent2.kind);
  }
};
__publicField$p(_RenderUpdatedEvent, "kind", "RenderUpdatedEvent");
let RenderUpdatedEvent = _RenderUpdatedEvent;
const _StateLoadingEvent = class _StateLoadingEvent2 {
  constructor() {
    __publicField$p(this, "kind", _StateLoadingEvent2.kind);
  }
};
__publicField$p(_StateLoadingEvent, "kind", "StateLoadingEvent");
...
const baseUrl = "./";
const assetUrl = "/dddg-assets/v2/assets/";
const packsUrl = `${baseUrl}packs/`;
const allowWebP = true;
const allowLq = true;
const NsfwPacks = {
...
function transactionLayer() {
  ...
  return function transaction2(callback) {
    return new Promise((resolve) => {
      const exec = () => __async$L(this, null, function* () {
        try {
...
var __publicField$o = (obj, key, value) => __defNormalProp$N(obj, typeof key !== "symbol" ? key + "" : key, value);
...
class Browser {
  constructor() {
    ...
    __publicField$o(this, "updateProgress", null);
    const self2 = this;
    ...
    if (canSave) {
      this.loading = (() => __async$K(this, null, function* () {
        this.savingEnabled = yield IndexedDBHandler.doesDbExists();
      }))();
    } else {
      this.loading = Promise.resolve();
    }
    this.loading.then(() => __async$K(this, null, function* () {
      var _a2;
      yield this.loadingContentPacksAllowed;
      if (this.creatingDB) yield this.creatingDB;
      if (this.savingEnabled) {
        ...
        const packUrls = yield Promise.all(
          autoload.map((compoundId) => __async$K(this, null, function* () {
            var _a22;
...
const IndexedDBHandler = {
  indexedDB: (() => {
    var _a2, _b, _c, _d;
    try {
      return (_d = (_c = (_b = (_a2 = window.indexedDB) != null ? _a2 : window.mozIndexedDB) != null ? _b : window.webkitIndexedDB) != null ? _c : window.msIndexedDB) != null ? _d : null;
    } catch (e) {
      return null;
    }
  })(),
  transaction: (() => {
    var _a2, _b, _c, _d;
    try {
      return (_d = (_c = (_b = (_a2 = window.IDBTransaction) != null ? _a2 : window.mozIDBTransaction) != null ? _b : window.webkitIDBTransaction) != null ? _c : window.msIDBTransaction) != null ? _d : null;
    } catch (e) {
      return null;
    }
  })(),
  ...
  createDB() {
    ...
    return IndexedDBHandler.db = new Promise((resolve, reject) => {
      ...
      req.onupgradeneeded = (event) => {
        var _a2;
        const db = req.result;
        const oldVer = (_a2 = event.oldVersion) != null ? _a2 : (
...
var __publicField$n = (obj, key, value) => __defNormalProp$M(obj, typeof key !== "symbol" ? key + "" : key, value);
class ImageAsset {
  constructor(html) {
    this.html = html;
...
var __publicField$m = (obj, key, value) => __defNormalProp$L(obj, typeof key !== "symbol" ? key + "" : key, value);
...
class ErrorAsset {
  constructor() {
    __publicField$m(this, "width", 300);
    __publicField$m(this, "height", 300);
  }
  paintOnto(fsCtx, opts = {}) {
    if (missing_image) {
...
var __publicField$l = (obj, key, value) => __defNormalProp$K(obj, key + "", value);
...
function isWebPSupported() {
  ...
  if (!envX.supports.allowWebP || !allowWebP) {
    return Promise.resolve(false);
  }
  ...
  return webpSupportPromise = (() => __async$J(this, null, function* () {
...
function isHeifSupported() {
  ...
  return heifSupportPromise = (() => __async$J(this, null, function* () {
...
function getAAssetUrl(asset, hq = true) {
  const url = envX.supports.lq && allowLq && !hq ? asset.lq : asset.hq;
...
function getBuildInAsset(asset, hq = true) {
  return __async$J(this, null, function* () {
    const url = `${assetUrl}${asset}${envX.supports.lq && allowLq && !hq ? ".lq" : ""}${(yield isWebPSupported()) ? ".webp" : ".png"}`.replace(/\/+/, "/");
    return yield getAssetCache().get(url);
  });
}
function getBuildInAssetUrl(asset, hq = true) {
  return __async$J(this, null, function* () {
    return `${assetUrl}${asset}${envX.supports.lq && allowLq && !hq ? ".lq" : ""}${(yield isWebPSupported()) ? ".webp" : ".png"}`.replace(/\/+/, "/");
  });
}
...
function requestAssetByUrl(url) {
  return __async$J(this, null, function* () {
    ...
    return yield (() => __async$J(this, null, function* () {
      try {
...
var __publicField$k = (obj, key, value) => __defNormalProp$J(obj, typeof key !== "symbol" ? key + "" : key, value);
...
class Electron {
  constructor() {
    __publicField$k(this, "state", reactive({
      looseTextParsing: true,
      autoAdd: [],
      downloadLocation: ""
    }));
    __publicField$k(this, "localRepositoryUrl", "/repo/");
    __publicField$k(this, "_gameMode", null);
    __publicField$k(this, "electron", window);
    __publicField$k(this, "$store", null);
    __publicField$k(this, "bgInvalidation", null);
    __publicField$k(this, "pendingContentPacks", []);
    __publicField$k(this, "pendingContentPacksReplace", []);
    __publicField$k(this, "loadingContentPacksAllowed");
    __publicField$k(this, "loadContentPacks");
    __publicField$k(this, "updateProgress", ref("wait"));
    __publicField$k(this, "supports", {
      autoLoading: true,
    ...
    __publicField$k(this, "savingEnabled", true);
    this.loadingContentPacksAllowed = new Promise((resolve) => {
      this.loadContentPacks = () => resolve();
    });
...
var __publicField$j = (obj, key, value) => __defNormalProp$I(obj, typeof key !== "symbol" ? key + "" : key, value);
...
const _Repo = class _Repo2 {
  constructor(onlineRepo, localRepo, $store) {
    this.$store = $store;
    __publicField$j(this, "onlineRepo");
    __publicField$j(this, "localRepo");
    __publicField$j(this, "tempRepo", reactive({
      authors: {},
      packs: []
    }));
    __publicField$j(this, "combinedList");
    __publicField$j(this, "authors");
    window.repo = this;
    if (!onlineRepo) {
    ...
    this.combinedList = computed(() => {
      ...
      return [
        ...
        var _a22, _b2, _c;
        return __spreadProps$o(__spreadValues$s(__spreadValues$s(__spreadValues$s({}, (_a22 = onlineRepoLookup.get(packId)) != null ? _a22 : {
          characters: [],
          kind: [],
          authors: []
  ...
  static getInstance() {
    if (!_Repo2.instance) _Repo2.instance = this.createInstance();
    return _Repo2.instance;
  }
  static createInstance() {
    return __async$H(this, null, function* () {
      const onlineRepoLoading = _Repo2.loadRepo(repoUrl);
      const localRepoLoading = envX.supports.localRepo ? yield _Repo2.loadRepo(envX.localRepositoryUrl) : null;
      const [onlineRepoLoaded, localRepoLoaded, $store] = yield Promise.all([
        onlineRepoLoading,
        localRepoLoading,
        _Repo2.$store
      ]);
      return new _Repo2(onlineRepoLoaded, localRepoLoaded, $store);
    });
  }
    ...
    return __async$H(this, null, function* () {
      try {
        const [packs, authors] = yield Promise.all([
          _Repo2.fetchJSON(repo + "repo.json"),
          _Repo2.fetchJSON(repo + "people.json")
        ]);
  ...
  reloadLocalRepo() {
    return __async$H(this, null, function* () {
      this.localRepo.value = envX.supports.localRepo ? yield _Repo2.loadRepo(envX.localRepositoryUrl) : null;
    });
  }
  getPacks() {
  ...
  addTempPack(pack, baseUrl2) {
    pack.repoUrl = baseUrl2;
    if (pack.dddg1Path) {
      pack.dddg1Path = new URL(pack.dddg1Path, baseUrl2).toString();
    }
    if (pack.dddg2Path) {
      pack.dddg2Path = new URL(pack.dddg2Path, baseUrl2).toString();
    }
    if (pack.preview) {
      for (let i = 0; i < pack.preview.length; ++i) {
        pack.preview[i] = new URL(pack.preview[i], baseUrl2).toString();
      }
    }
...
__publicField$j(_Repo, "instance");
__publicField$j(_Repo, "setStore");
__publicField$j(_Repo, "$store", new Promise(
  (resolve) => {
...
function extractStyleGroups(characterV1, ctx, nsfw) {
  ...
  var _loop_1 = function(styleName2) {
    ...
    try {
      ...
      try {
        if (useComponents_1_1 && !useComponents_1_1.done && (_a3 = useComponents_1.return)) _a3.call(useComponents_1);
      } finally {
        if (e_2) throw e_2.error;
      }
    }
  ...
  try {
    ...
    try {
      if (styleNames_1_1 && !styleNames_1_1.done && (_a2 = styleNames_1.return)) _a2.call(styleNames_1);
    } finally {
      if (e_1) throw e_1.error;
    }
  }
...
function convertContentPack(pack) {
  return __async$G(this, null, function* () {
    ...
    return assetWalker_1(pack, (path) => {
      var _a2;
...
var __publicField$i = (obj, key, value) => __defNormalProp$G(obj, typeof key !== "symbol" ? key + "" : key, value);
const _RGBAColor = class _RGBAColor2 {
  constructor(r, g, b, a) {
    this.r = r;
    this.g = g;
    this.b = b;
...
__publicField$i(_RGBAColor, "rgbEx", /^rgb\((\d*?),(\d*?),(\d*?)\)$/i);
__publicField$i(_RGBAColor, "rgbaEx", /^rgba\((\d{1,3}),(\d{1,3}),(\d{1,3}),([\d.]+)\)$/i);
__publicField$i(_RGBAColor, "hexShortEx", /^#[0-9A-F]{3,4}$/i);
__publicField$i(_RGBAColor, "hexLongEx", /^#[0-9A-F]{6,8}$/i);
...
function getConstants() {
  if (envX.gameMode === "ddlc_plus") return DdlcPlus;
  return Ddlc;
}
...
var __publicField$h = (obj, key, value) => __defNormalProp$z(obj, key + "", value);
...
var __publicField$g = (obj, key, value) => __defNormalProp$y(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var strictDeepOmit = {};
Object.defineProperty(strictDeepOmit, "__esModule", { value: true });
var deepOmit = {};
Object.defineProperty(deepOmit, "__esModule", { value: true });
var deepPartial = {};
Object.defineProperty(deepPartial, "__esModule", { value: true });
var strictDeepPick = {};
Object.defineProperty(strictDeepPick, "__esModule", { value: true });
var deepPick = {};
...
(function(exports) {
  ...
  __exportStar(pathValue, exports);
  __exportStar(paths, exports);
  __exportStar(pickProperties, exports);
  __exportStar(prettify, exports);
  ...
  __exportStar(strictDeepOmit, exports);
  __exportStar(deepOmit, exports);
  __exportStar(deepPartial, exports);
  __exportStar(strictDeepPick, exports);
...
function setFilter(action, objLookup, setMutation) {
  const obj = objLookup();
  const filters = [...obj.filters];
  const filter = __spreadValues$i({}, filters[action.idx]);
...
var __publicField$f = (obj, key, value) => __defNormalProp$v(obj, typeof key !== "symbol" ? key + "" : key, value);
class Renderable {
  constructor(obj) {
    this.obj = obj;
...
var __publicField$e = (obj, key, value) => __defNormalProp$u(obj, typeof key !== "symbol" ? key + "" : key, value);
...
class AssetListRenderable extends Renderable {
  ...
  prepareRender(lq) {
    ...
    if (this.isAssetListOutdated()) {
      ...
      reloadAssets || (reloadAssets = !!this.assetList.find(
    ...
    if (!lq !== this.lastHq) {
      for (let i = 0; i < this.assetList.length; ++i) {
        ...
        if ("loadedAssets" in asset && !asset.assets.every((x) => x.hq === x.lq)) {
          this.assetList[i] = {
            assets: asset.assets,
            offset: asset.offset,
...
class Character extends AssetListRenderable {
  ...
  getAssetList() {
    ...
    const drawAssetsNew = [];
    const oldAssets = (_a2 = this.assetList) != null ? _a2 : [];
    for (const renderCommand of pose.renderCommands) {
      ...
      if (newAssets) {
        ...
        if (oldEntry) {
          drawAssetsNew.push(__spreadProps$f(__spreadValues$h({}, oldEntry), {
...
var __publicField$d = (obj, key, value) => __defNormalProp$s(obj, key + "", value);
...
function tokenStateNormal(contents, walker) {
  if (walker.current() === void 0) return tokenStateEnd;
...
const textCommands = new Map([
  paramlessOp("i", (style) => __spreadProps$e(__spreadValues$g({}, style), { isItalic: true })),
  paramlessOp("b", (style) => __spreadProps$e(__spreadValues$g({}, style), { isBold: true })),
  paramlessOp("u", (style) => __spreadProps$e(__spreadValues$g({}, style), { isUnderlined: true })),
  paramlessOp("s", (style) => __spreadProps$e(__spreadValues$g({}, style), {
    isStrikethrough: true
  })),
  paramlessOp("plain", (style) => __spreadProps$e(__spreadValues$g({}, style), {
    isStrikethrough: false,
    isUnderlined: false,
    isBold: false,
    isItalic: false
  })),
  paramlessOp("edited", (style) => __spreadProps$e(__spreadValues$g({}, style), {
    fontName: "verily",
    strokeColor: "#000000",
    strokeWidth: 20,
    letterSpacing: 8
  })),
  relativeNumberOp("k", (style, relative, parameter) => __spreadProps$e(__spreadValues$g({}, style), {
    letterSpacing: relative ? style.letterSpacing + parameter : parameter
  })),
  relativeNumberOp("size", (style, relative, parameter) => __spreadProps$e(__spreadValues$g({}, style), {
    fontSize: relative ? style.fontSize + parameter : parameter
  })),
  relativeNumberOp("alpha", (style, relative, parameter) => __spreadProps$e(__spreadValues$g({}, style), {
    alpha: relative ? style.alpha + parameter : parameter
  })),
  relativeNumberOp("stroke", (style, relative, parameter) => __spreadProps$e(__spreadValues$g({}, style), {
    strokeWidth: relative ? style.strokeWidth + parameter : parameter
  })),
  [
    "font",
    (style, parameter) => {
      return __spreadProps$e(__spreadValues$g({}, style), { fontName: parameter });
    }
  ],
  [
    "color",
    (style, parameter) => {
      return __spreadProps$e(__spreadValues$g({}, style), { color: parameter });
    }
  ],
  [
    "outlinecolor",
    (style, parameter) => {
      return __spreadProps$e(__spreadValues$g({}, style), { strokeColor: parameter });
    }
  ]
]);
...
var __publicField$c = (obj, key, value) => __defNormalProp$q(obj, typeof key !== "symbol" ? key + "" : key, value);
class TextRenderer {
  constructor(str, baseStyle) {
    ...
    __publicField$c(this, "lastLayoutHeight", null);
    __publicField$c(this, "lastLayoutWidth", null);
  ...
  applyLayout(defaultAlignment, xStart, yStart, w, automaticLineBreak) {
    ...
    function placeLayoutGroup(group, startX, y2) {
      let x = startX;
...
var __publicField$b = (obj, key, value) => __defNormalProp$p(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$o = Object.defineProperty;
var __defNormalProp$o = (obj, key, value) => key in obj ? __defProp$o(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$a = (obj, key, value) => __defNormalProp$o(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$n = Object.defineProperty;
var __defNormalProp$n = (obj, key, value) => key in obj ? __defProp$n(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$9 = (obj, key, value) => __defNormalProp$n(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$m = Object.defineProperty;
var __defNormalProp$m = (obj, key, value) => key in obj ? __defProp$m(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$8 = (obj, key, value) => __defNormalProp$m(obj, key + "", value);
...
var __defProp$l = Object.defineProperty;
var __defNormalProp$l = (obj, key, value) => key in obj ? __defProp$l(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$7 = (obj, key, value) => __defNormalProp$l(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$k = Object.defineProperty;
var __defNormalProp$k = (obj, key, value) => key in obj ? __defProp$k(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$6 = (obj, key, value) => __defNormalProp$k(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __publicField$5 = (obj, key, value) => __defNormalProp$j(obj, typeof key !== "symbol" ? key + "" : key, value);
class Custom extends DdlcBase {
  ...
  get nameboxStyle() {
    return __spreadProps$d(__spreadValues$f({}, NameboxTextStyle$1), {
...
var __defProp$i = Object.defineProperty;
var __defNormalProp$i = (obj, key, value) => key in obj ? __defProp$i(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$4 = (obj, key, value) => __defNormalProp$i(obj, typeof key !== "symbol" ? key + "" : key, value);
...
const _DdlcPlusBase = class _DdlcPlusBase2 {
  constructor(base) {
    this.base = base;
  ...
  renderControls(rx, y) {
    ...
    for (const text of texts) {
      const width = _DdlcPlusBase2.controlWidth(rx, text);
...
__publicField$4(_DdlcPlusBase, "widthCache", {});
...
var __publicField$3 = (obj, key, value) => __defNormalProp$h(obj, typeof key !== "symbol" ? key + "" : key, value);
class CustomPlus extends DdlcPlusBase {
  ...
  get nameboxStyle() {
    return __spreadProps$c(__spreadValues$e({}, NameboxTextStyle), {
      strokeColor: this.nameboxOutlineColor,
      color: "#FFFFFF"
    });
  }
...
var __defProp$g = Object.defineProperty;
var __defNormalProp$g = (obj, key, value) => key in obj ? __defProp$g(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$2 = (obj, key, value) => __defNormalProp$g(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$f = Object.defineProperty;
var __defNormalProp$f = (obj, key, value) => key in obj ? __defProp$f(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$1 = (obj, key, value) => __defNormalProp$f(obj, typeof key !== "symbol" ? key + "" : key, value);
...
var __defProp$e = Object.defineProperty;
var __defNormalProp$e = (obj, key, value) => key in obj ? __defProp$e(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp$e(obj, typeof key !== "symbol" ? key + "" : key, value);
...
const _SceneRenderer = class _SceneRenderer2 {
  ...
  renderCallback(skipLocalCanvases, rx) {
    return __async$u(this, null, function* () {
      ...
      const focusedObjId = (_b = document.querySelector(_SceneRenderer2.FocusProp)) == null ? void 0 : _b.getAttribute("data-obj-id");
...
function getMainSceneRenderer(store2) {
  if (sceneRenderer === null || sceneRenderer.disposed) {
    if (store2.state.panels.currentPanel === -1) return null;
...
const choiceActions = {
  createChoice({ commit: commit2, rootState, state }, command) {
    ...
    const id = state.panels[command.panelId].lastObjId + 1;
    commit2("create", {
      object: __spreadProps$b(__spreadValues$d({}, baseProps()), {
...
const notificationActions = {
  createNotification({ commit: commit2, rootState, state }, command) {
    ...
    const id = state.panels[command.panelId].lastObjId + 1;
    commit2("create", {
      object: __spreadProps$a(__spreadValues$c({}, baseProps()), {
...
const poemActions = {
  ...
  createConsole({ commit: commit2, rootState, state }, _command) {
    ...
    commit2("create", {
      object: __spreadProps$9(__spreadValues$b({}, baseProps()), {
        subType: "console",
...
const spriteActions = {
  createSprite(_0, _1) {
    return __async$t(this, arguments, function* ({ commit: commit2, rootState, state }, command) {
      ...
      const id = state.panels[command.panelId].lastObjId + 1;
      commit2("create", {
        object: __spreadProps$8(__spreadValues$a({}, baseProps()), {
...
const actions = __spreadValues$8(__spreadValues$8(__spreadValues$8(__spreadValues$8(__spreadValues$8(__spreadValues$8({
  removeObject({ state, commit: commit2, rootState }, command) {
    ...
    for (const key of [...panel.onTopOrder, ...panel.order]) {
      ...
      if (otherObject.linkedTo === obj.id) {
        ...
        if (otherObjRender) {
          commit2("setLink", __spreadValues$8({
            panelId: command.panelId,
            id: otherObject.id,
            link: null
  ...
  copyObjects({ commit: commit2, state }, { sourcePanelId, targetPanelId }) {
    ...
    for (const sourceId of allSourceIds) {
      ...
      commit2("create", {
        object: __spreadProps$6(__spreadValues$8({}, newObject), {
  ...
  pasteObjectFromClipboard({ commit: commit2, state, rootState }) {
    ...
    for (const obj of newObjects) {
      ...
      commit2("create", {
        object: __spreadProps$6(__spreadValues$8({}, obj), {
...
const panels = {
  ...
  actions: __spreadValues$7({
    ...
    duplicatePanel({ state, commit: commit2 }, { panelId }) {
      ...
      commit2("createPanel", {
        panel: __spreadProps$5(__spreadValues$7({}, newPanel), {
          id,
          lastObjId,
          objects: newObjects,
  ...
  actions: {
    ...
    getSave(_0, _1) {
      return __async$q(this, arguments, function* ({ state }, compact) {
        const repo = yield Repo.getInstance();
        return JSON.stringify(
          __spreadProps$4(__spreadValues$6({}, state), { version: 2.5 }),
          (key, value) => {
            if (key === "ui") return void 0;
            if (key === "lastRender") return void 0;
    ...
    loadSave(_0, _1) {
      return __async$q(this, arguments, function* ({ state }, str) {
        ...
        data.ui = __spreadProps$4(__spreadValues$6({}, getDefaultUiState()), {
...
const _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    eventBus$1.subscribe(CustomAssetFailureEvent, () => {
      messages.value.push(
...
const MessageConsole = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["__scopeId", "data-v-478800c0"]]);
const _hoisted_1$t = {
  key: 0,
  id: "submit-options"
};
...
const ModalDialog = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-8b486fbc"]]);
const scale = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20height='24'%20viewBox='0%20-960%20960%20960'%20width='24'%20fill='%23000'%20stroke='%23000'%3e%3cpath%20d='M120-120v-320h80v184l504-504H520v-80h320v320h-80v-184L256-200h184v80H120Z'/%3e%3c/svg%3e";
const scaleDark = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20height='24'%20viewBox='0%20-960%20960%20960'%20width='24'%20fill='%23fff'%20stroke='%23fff'%3e%3cpath%20d='M120-120v-320h80v184l504-504H520v-80h320v320h-80v-184L256-200h184v80H120Z'/%3e%3c/svg%3e";
const rotate = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20height='24'%20viewBox='0%20-960%20960%20960'%20width='24'%20fill='%23000'%20stroke='%23000'%3e%3cpath%20d='M440-80q-50-5-96-24.5T256-156l56-58q29%2021%2061.5%2034t66.5%2018v82Zm80%200v-82q104-15%20172-93.5T760-438q0-117-81.5-198.5T480-718h-8l64%2064-56%2056-160-160%20160-160%2056%2058-62%2062h6q75%200%20140.5%2028.5t114%2077q48.5%2048.5%2077%20114T840-438q0%20137-91%20238.5T520-80ZM198-214q-32-42-51.5-88T122-398h82q5%2034%2018%2066.5t34%2061.5l-58%2056Zm-76-264q6-51%2025-98t51-86l58%2056q-21%2029-34%2061.5T204-478h-82Z'/%3e%3c/svg%3e";
const rotateDark = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20height='24'%20viewBox='0%20-960%20960%20960'%20width='24'%20fill='%23fff'%20stroke='%23fff'%3e%3cpath%20d='M440-80q-50-5-96-24.5T256-156l56-58q29%2021%2061.5%2034t66.5%2018v82Zm80%200v-82q104-15%20172-93.5T760-438q0-117-81.5-198.5T480-718h-8l64%2064-56%2056-160-160%20160-160%2056%2058-62%2062h6q75%200%20140.5%2028.5t114%2077q48.5%2048.5%2077%20114T840-438q0%20137-91%20238.5T520-80ZM198-214q-32-42-51.5-88T122-398h82q5%2034%2018%2066.5t34%2061.5l-58%2056Zm-76-264q6-51%2025-98t51-86l58%2056q-21%2029-34%2061.5T204-478h-82Z'/%3e%3c/svg%3e";
...
const grabbies = [
  {
    ...
    onStartMove(_store, obj, dragData2) {
...
function onMove(store2, pos, shift) {
  ...
  if (!dragData.started) {
    ...
    const renderObj = sceneRenderer2.getLastRenderObject(obj.id);
...
const _sfc_main$z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    function onUiClick(e) {
      ...
      transaction(() => {
        if (store2.state.ui.selection === selectedObject) return;
      ...
      return __async$m(this, null, function* () {
        ...
        for (const item of e.dataTransfer.items) {
          if (item.kind === "file" && item.type.match(/image.*/)) {
            ...
            try {
              const assetUrl2 = yield store2.dispatch("uploadUrls/add", {
                name: file.name,
                url
              });
...
const DButton = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["__scopeId", "data-v-1cfc383f"]]);
...
function setupPanelMixin(root) {
  ...
  onMounted(() => {
    ...
    getRoot().addEventListener(
      "wheel",
      (e) => {
        if (!vertical.value) verticalScrollRedirect(e);
      },
      { passive: true }
    );
  });
...
const Characters = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-290fbfb1"]]);
...
const DropTarget = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["__scopeId", "data-v-4179078f"]]);
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const sprites = computed(() => {
      return store2.state.content.current.sprites.map((x) => {
        ...
        return __spreadProps$3(__spreadValues$5({}, x), {
          missing,
          urls
        });
      });
    ...
    function onMissingSpriteFileUpload() {
      return __async$k(this, null, function* () {
    ...
    function addCustomSpriteFile(file) {
      return __async$k(this, null, function* () {
        yield transaction((subTransaction) => __async$k(this, null, function* () {
          ...
          yield addNewCustomSprite(file.name, assetUrl2, subTransaction);
        }));
      });
    }
    function addNewCustomSprite(_0, _1) {
      return __async$k(this, arguments, function* (label, url, subTransaction = transaction) {
        ...
        const newPackVersion = __spreadProps$3(__spreadValues$5({}, old), {
          sprites: [
            ...old.sprites,
            {
              id: url,
...
const Sprites = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-57addb81"]]);
var __async$j = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
...
const _withScopeId$d = (n) => (pushScopeId("data-v-936da669"), n = n(), popScopeId(), n);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        ref_key: "root",
        ref: root,
        onDragenter: _cache[2] || (_cache[2] = //@ts-ignore
        (...args) => {
          var _a2, _b;
...
const AddPanel = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-936da669"]]);
...
const DFlow = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-6e3f0ae5"]]);
let lastId = 0;
...
const Slider = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-476d0fd9"]]);
...
const SliderGroup = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-468fba75"]]);
...
const _sfc_main$p = /* @__PURE__ */ defineComponent(__spreadProps$2(__spreadValues$4({}, { inheritAttrs: false }), {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function addSwatch() {
      if (swatches.value.find((swatch) => swatch.color === color2.value)) return;
...
const Color = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-f4583641"]]);
...
const DFieldset = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-2b2d1b79"]]);
...
const _withScopeId$c = (n) => (pushScopeId("data-v-68a8cfa8"), n = n(), popScopeId(), n);
...
const _hoisted_19$3 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "color-burn" }, "color-burn", -1));
const _hoisted_20$4 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "hard-light" }, "hard-light", -1));
const _hoisted_21$4 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "soft-light" }, "soft-light", -1));
const _hoisted_22$2 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "difference" }, "difference", -1));
const _hoisted_23$2 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "exclusion" }, "exclusion", -1));
const _hoisted_24$2 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "hue" }, "hue", -1));
const _hoisted_25$2 = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createBaseVNode("option", { value: "saturation" }, "saturation", -1));
...
const ImageOptions = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-68a8cfa8"]]);
var __async$f = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
  ...
  setup(__props) {
    ...
    const style = computed(() => {
      ...
      const urls = (_a2 = bgData.value) == null ? void 0 : _a2.variants[0].map((img) => {
        const assetUrl2 = getAAssetUrl(img, false);
        if (assetUrl2.startsWith("uploads:")) {
          missingAsset = true;
        }
        return `url('${assetUrl2}')`;
      }).join(",");
      if (missingAsset) {
        Object.keys(store2.state.uploadUrls);
      }
...
const BackgroundButton = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-7f206a86"]]);
...
const _withScopeId$b = (n) => (pushScopeId("data-v-45ed9d5e"), n = n(), popScopeId(), n);
...
const BackgroundSettings = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-45ed9d5e"]]);
...
const _withScopeId$a = (n) => (pushScopeId("data-v-053f624c"), n = n(), popScopeId(), n);
    ...
    function addImageFile(file) {
      return __async$d(this, null, function* () {
        yield transaction(() => __async$d(this, null, function* () {
          ...
          yield addNewCustomBackground(file.name, file.name, assetUrl2);
        }));
      });
    }
    function addByUrl() {
...
const BackgroundsPanel = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-053f624c"]]);
...
const PartButton = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-a3759986"]]);
var __async$b = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function updatePose(styleGroupId) {
      if (styleGroupId == void 0) styleGroupId = props.character.styleGroupId;
      const data = charData.value;
          ...
          createVNode(DFlow, {
            ...
            default: withCtx(() => [
              ...
              __props.part === "head" ? (openBlock(), createBlock(DButton, {
                ...
                onClick: _cache[2] || (_cache[2] = ($event) => emit2("show-expression-dialog", { character: __props.character.characterType }))
              }, {
                default: withCtx(() => [
...
const Parts = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-5aaca212"]]);
var __async$a = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
...
const Layers = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-cbbfa547"]]);
...
const _withScopeId$9 = (n) => (pushScopeId("data-v-1e76fbe4"), n = n(), popScopeId(), n);
...
const PositionAndSize = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-1e76fbe4"]]);
...
const _withScopeId$8 = (n) => (pushScopeId("data-v-9474f8f5"), n = n(), popScopeId(), n);
...
const _hoisted_10$5 = /* @__PURE__ */ createStaticVNode('<option value data-v-9474f8f5>Font</option><option value="aller" style="font-family:aller;" data-v-9474f8f5> Aller (Textbox) </option><option value="riffic" style="font-family:riffic;" data-v-9474f8f5> Riffic (Bold text) </option><option value="hashtag" style="font-family:hashtag;" data-v-9474f8f5> Hashtag (Sayori) </option><option value="ammy_handwriting" style="font-family:ammy_handwriting;" data-v-9474f8f5> Ammy&#39;s Handwriting (Natsuki) </option><option value="journal" style="font-family:journal;" data-v-9474f8f5> Journal (Monika) </option><option value="jp_hand_slanted" style="font-family:jp_hand_slanted;" data-v-9474f8f5> JP Hand Slanted (Yuri) </option><option value="damagrafik_script" style="font-family:damagrafik_script;" data-v-9474f8f5> Damagrafik (Yuri, Act 2) </option><option value="as_i_lay_dying" style="font-family:as_i_lay_dying;" data-v-9474f8f5> As I Lay Dying (Yuri, Act Unused) </option><option value="halogen" style="font-family:halogen;" data-v-9474f8f5> Halogen (MC) </option>', 10);
const _hoisted_20$3 = [
  _hoisted_10$5
];
const _hoisted_21$3 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("option", { value: "" }, "Alignment", -1));
const _hoisted_22$1 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("option", {
  value: "left",
  style: { "text-align": "left" }
}, "Left", -1));
const _hoisted_23$1 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("option", {
  value: "right",
  style: { "text-align": "right" }
}, "Right", -1));
const _hoisted_24$1 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("option", {
  value: "center",
  style: { "text-align": "center" }
}, "Center", -1));
const _hoisted_25$1 = [
    ...
    return (_ctx, _cache) => {
      return colorSelector.value ? (openBlock(), createBlock(Color, {
        ...
        createBaseVNode("div", _hoisted_9$6, [
          ...
          withDirectives(createBaseVNode("select", {
            "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => selectedAlignment.value = $event),
            class: "style-button"
          }, _hoisted_25$1, 512), [
            [vModelSelect, selectedAlignment.value]
          ]),
          createBaseVNode("button", {
            onClick: _cache[16] || (_cache[16] = ($event) => selectColor("text")),
            class: "style-button"
          }, " Text color "),
          createBaseVNode("button", {
            onClick: _cache[17] || (_cache[17] = ($event) => selectColor("outline")),
            class: "style-button"
          }, " Outline color ")
        ])
      ], 2));
...
const TextEditor = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-9474f8f5"]]);
      ...
      set(value) {
        ...
        try {
          ...
          if (e instanceof Error) {
            ...
            eventBus$1.fire(new FailureEvent("" + e));
          }
        }
      }
    });
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      ...
      if (obj.type !== "character") return void 0;
      return obj;
    });
    ...
    function onMissingHeadFileUpload() {
...
const CharacterPanel = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-37b64457"]]);
...
const _withScopeId$6 = (n) => (pushScopeId("data-v-dffedce9"), n = n(), popScopeId(), n);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      ...
      if (obj.type !== "choice") return void 0;
      return obj;
    });
    ...
    const textHandler = computed(() => {
      if (!textEditor.value) return void 0;
      return {
        title: "Text",
        get: () => {
...
const ChoicePanel = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-dffedce9"]]);
const _withScopeId$5 = (n) => (pushScopeId("data-v-c47263ec"), n = n(), popScopeId(), n);
...
const CreditsPanel = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-c47263ec"]]);
const _withScopeId$4 = (n) => (pushScopeId("data-v-ab1f3f6c"), n = n(), popScopeId(), n);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      const obj = currentPanel.value.objects[store2.state.ui.selection];
      if (obj.type !== "notification") return void 0;
      return obj;
    });
...
const NotificationPanel = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-ab1f3f6c"]]);
...
const _withScopeId$3 = (n) => (pushScopeId("data-v-4aaa8b42"), n = n(), popScopeId(), n);
...
const _hoisted_19$2 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_20$2 = { colspan: "2" };
const _hoisted_21$2 = { class: "column" };
  ...
  setup(__props) {
    ...
    function restoreThumbnails() {
      return __async$4(this, null, function* () {
        ...
        if (envX.supports.limitedCanvasSpace) return;
                  ...
                  createBaseVNode("td", null, [
                    withDirectives(createBaseVNode("input", {
                      ...
                      onBlur: _cache[7] || (_cache[7] = ($event) => {
                        if (emptyStringInInt(ppi.value)) ppi.value = 0;
                      })
                    }, null, 544), [
                      [
                        vModelText,
...
const PanelsPanel = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-4aaa8b42"]]);
const _withScopeId$2 = (n) => (pushScopeId("data-v-758b6734"), n = n(), popScopeId(), n);
const _hoisted_1$5 = {
  id: "poem_text",
  class: "v-w100"
};
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      const obj = currentPanel.value.objects[store2.state.ui.selection];
      if (obj.type !== "poem") return void 0;
      return obj;
    });
    ...
    const colorHandler = computed(() => {
      if (!colorSelect.value) return void 0;
      return {
        title: "Color",
        get: () => {
...
const PoemPanel = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-758b6734"]]);
...
const _hoisted_14$1 = { class: "v-w100" };
const _hoisted_15$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("td", null, [
  /* @__PURE__ */ createBaseVNode("label", null, "Theme:")
], -1));
const _hoisted_16$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("option", { value: null }, "System", -1));
const _hoisted_17$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("option", { value: false }, "Light", -1));
const _hoisted_18$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("option", { value: true }, "Dark", -1));
const _hoisted_19$1 = [
  _hoisted_16$1,
  _hoisted_17$1,
  _hoisted_18$1
...
const _hoisted_21$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("td", null, [
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const store2 = useStore();
    const root = ref(null);
    const updateProgress = envX.updateProgress;
    setupPanelMixin(root);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(updateProgress) === "done" ? (openBlock(), createElementBlock("p", _hoisted_10$1, " Update is successfully downloaded. It will be installed once the application is closed. ")) : createCommentVNode("", true),
        unref(updateProgress) === "wait" ? (openBlock(), createElementBlock("p", _hoisted_11$1, "Checking for updates...")) : createCommentVNode("", true),
        typeof unref(updateProgress) === "number" ? (openBlock(), createElementBlock("p", _hoisted_12$1, " Downloading update (" + toDisplayString(unref(updateProgress)) + "%) ", 1)) : createCommentVNode("", true),
        waitOnSaveChange.value ? (openBlock(), createElementBlock("button", _hoisted_13$1, "Applying...")) : !savesAllowed.value && savesEnabledInEnv.value ? (openBlock(), createElementBlock("button", {
          key: 4,
        ...
        createBaseVNode("button", {
          ...
          class: normalizeClass(savesEnabledInEnv.value ? "bt0" : "")
        }, [
        ...
        showDownloadFolder.value ? (openBlock(), createElementBlock("table", _hoisted_20$1, [
          createBaseVNode("tr", null, [
            _hoisted_21$1,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      const obj = currentPanel.value.objects[store2.state.ui.selection];
      if (obj.type !== "sprite") return void 0;
      return obj;
    });
    function reupload() {
...
const SpritePanel = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1946d52a"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-cc9e47ba"), n = n(), popScopeId(), n);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const object = computed(() => {
      const obj = currentPanel.value.objects[store2.state.ui.selection];
      if (obj.type !== "textBox") return void 0;
      return obj;
    });
...
const TextBoxPanel = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cc9e47ba"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function updateArea() {
      ...
      if (store2.state.ui.vertical === v) return;
    ...
    function onKeydown(e) {
      ...
      transaction(() => __async2(this, null, function* () {
        ...
        if (noMod && e.key === "Escape") {
          if (store2.state.ui.selection === null) return;
          store2.commit("ui/setSelection", null);
          return;
        }
    ...
    function select(id) {
      transaction(() => {
        if (store2.state.ui.selection === id) return;
