import { J as reactive, d as defineComponent, c as computed, o as openBlock, a as createElementBlock, b as createBaseVNode, t as toDisplayString, s as normalizeStyle, v as withModifiers, _ as _export_sfc, K as renderSlot, u as useStore, r as ref, L as getAAssetUrl, w as watch, p as createBlock, h as withCtx, F as Fragment, e as renderList, k as createTextVNode, m as _sfc_main$3, f as createCommentVNode, g as createVNode, M as DropTarget, l as unref, N as verticalScrollRedirect, n as normalizeClass, C as withDirectives, O as vModelSelect, D as vModelText, P as DFieldset, q as _sfc_main$4, Q as Character, i as nextTick, S as Renderer, U as ScalingModes, W as AssetListRenderable, X as SelectedState, Y as getAssetByUrl, Z as transaction, j as envX, x as pushScopeId, y as popScopeId } from "./index-BtNokc2I.js";
...
class WorkBatch {
  ...
  reject(e) {
    ...
    for (const data of returnData) {
      if (data !== void 0) this.remainingDisposers.add(data);
    }
    rejectCurrentRun();
  }
  reset() {
...
const Selection = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-619fdaf7"]]);
const _sfc_main$1 = {};
...
const _withScopeId = (n) => (pushScopeId("data-v-96cc8bfd"), n = n(), popScopeId(), n);
          ...
          !uploadsFinished.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
            ...
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", {
                ...
                onWheelPassive: _cache[1] || (_cache[1] = //@ts-ignore
                (...args) => unref(verticalScrollRedirect) && unref(verticalScrollRedirect)(...args))
              }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-96cc8bfd"]]);
export {
  index as default
};
