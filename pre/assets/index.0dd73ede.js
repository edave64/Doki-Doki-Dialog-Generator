...
let Repo = _Repo;
__publicField$j(Repo, "instance");
__publicField$j(Repo, "setStore");
__publicField$j(Repo, "$store", new Promise(
  (resolve, _reject) => {
...
const _withScopeId$2 = (n) => (pushScopeId("data-v-9239d97d"), n = n(), popScopeId(), n);
const _hoisted_1$5 = {
  id: "poem_text",
  class: "v-w100"
};
...
const poem_vue_vue_type_style_index_0_scoped_9239d97d_lang = "";
const PoemPanel = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9239d97d"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const SingleBox = defineAsyncComponent(
      () => __vitePreload(() => import("./single-box.3c5fee24.js"), true ? ["./single-box.3c5fee24.js","./single-box.8bbdee98.css"] : void 0, import.meta.url)
    );
    const ExpressionBuilder = defineAsyncComponent(
      () => __vitePreload(() => import("./index.054556ae.js"), true ? ["./index.054556ae.js","./index.bd62f983.css"] : void 0, import.meta.url)
    );
    const store2 = useStore();
