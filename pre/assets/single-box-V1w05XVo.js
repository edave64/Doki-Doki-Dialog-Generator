import { d as defineComponent, r as ref, c as computed, w as watch, o as openBlock, a as createElementBlock, b as createBaseVNode, F as Fragment, e as renderList, t as toDisplayString, f as createCommentVNode, g as createVNode, h as withCtx, n as normalizeClass, T as TransitionGroup, i as nextTick, _ as _export_sfc, u as useStore, j as envX, k as createTextVNode, l as unref, m as _sfc_main$4, p as createBlock, q as _sfc_main$5, s as normalizeStyle, v as withModifiers, x as pushScopeId, y as popScopeId, z as errorReport, A as onMounted, B as onUnmounted, C as withDirectives, D as vModelText, E as createStaticVNode, G as onActivated, H as safeAsync, R as Repo, I as eventBus, V as VueErrorEvent } from "./index-BtNokc2I.js";
...
const List = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-61b2f5f0"]]);
const allowedTags = [
  "h3",
  "h4",
  "h5",
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-840e1724"), n = n(), popScopeId(), n);
...
const _hoisted_8$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("i", { class: "material-icons" }, "add", -1));
const _hoisted_9$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("i", { class: "material-icons" }, "remove", -1));
const _hoisted_10 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("h3", null, "Authors", -1));
const _hoisted_11 = ["title", "src"];
const _hoisted_12 = { key: 2 };
const _hoisted_13 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("h3", null, "Credits", -1));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const installable = computed(() => {
      if (!envX.supports.localRepo) return false;
    ...
    function uninstall() {
      return __async$1(this, null, function* () {
        ...
        if (pack_.repoUrl != null && !((_a = props.repo) == null ? void 0 : _a.hasPack(pack_.id, true))) {
          yield props.repo.loadTempPack(pack_.repoUrl);
        }
        try {
          processingPack.value = true;
          yield envX.localRepoUninstall(pack_.id);
        } finally {
          processingPack.value = false;
        }
      });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("section", null, [
          ...
          processingPack.value ? (openBlock(), createElementBlock("button", _hoisted_7$1, "Processing...")) : (openBlock(), createElementBlock(Fragment, { key: 3 }, [
        ...
        pack.value.description ? (openBlock(), createElementBlock("section", _hoisted_12, [
          _hoisted_13,
          createBaseVNode("p", {
...
const PackDisplay = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-840e1724"]]);
const _withScopeId = (n) => (pushScopeId("data-v-de18751f"), n = n(), popScopeId(), n);
...
const _hoisted_9 = /* @__PURE__ */ createStaticVNode("<p data-v-de18751f>Enter the text you want to search for. E.g. <code data-v-de18751f>Monika</code></p><p data-v-de18751f> If multiple words are given, each word must be found. E.g. <code data-v-de18751f>Monika Pose</code></p><p data-v-de18751f> To search phrases with spaces, surround them with double quotes. E.g. <code data-v-de18751f>&quot;Monika R63&quot; Pose</code></p><p data-v-de18751f> To limit your search to specific attributes of a pack, you can use the following prefixes: </p><table data-v-de18751f><tr data-v-de18751f><th data-v-de18751f>Prefix</th><th data-v-de18751f>Description</th><th data-v-de18751f>Example</th></tr><tr data-v-de18751f><td data-v-de18751f>Character:</td><td data-v-de18751f></td><td data-v-de18751f><code data-v-de18751f>Character: Monika</code></td></tr><tr data-v-de18751f><td data-v-de18751f>Artist:</td><td data-v-de18751f></td><td data-v-de18751f><code data-v-de18751f>Artist: edave64</code></td></tr><tr data-v-de18751f><td data-v-de18751f>Type:</td><td data-v-de18751f><code data-v-de18751f>Backgrounds</code>, <code data-v-de18751f>Sprites</code>, <code data-v-de18751f>Expressions</code>, <code data-v-de18751f>Styles</code>, <code data-v-de18751f>Poses</code> or <code data-v-de18751f>Characters</code></td><td data-v-de18751f><code data-v-de18751f>Type: Poses</code></td></tr><tr data-v-de18751f><td data-v-de18751f>Engine:</td><td data-v-de18751f><code data-v-de18751f>Doki Doki Dialog Generator</code>, <code data-v-de18751f>DDDG</code> or <code data-v-de18751f>Doki Doki Comic Club</code>, <code data-v-de18751f>DDCC</code></td><td data-v-de18751f><code data-v-de18751f>Engine: DDCC</code></td></tr><tr data-v-de18751f><td data-v-de18751f>Pack:</td><td data-v-de18751f>The pack itself must contain the text</td><td data-v-de18751f><code data-v-de18751f>Pack: Angry</code></td></tr></table><p data-v-de18751f> Prefixes can be shorted, so <code data-v-de18751f>Character: Monika</code> can be shortend to <code data-v-de18751f>C: Monika</code></p>", 6);
const _hoisted_15 = [
  _hoisted_9
];
const debounce = 250;
...
const SearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-de18751f"]]);
...
const singleBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3376703f"]]);
export {
